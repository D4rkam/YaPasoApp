...
class LoadBalanceV2Page extends StatelessWidget with ResponsiveMixin {
  LoadBalanceV2Page({super.key});

  final BalanceControllerV2 controller = Get.find<BalanceControllerV2>();
