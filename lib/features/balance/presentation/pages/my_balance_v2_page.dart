...
class MyBalanceV2Page extends StatelessWidget with ResponsiveMixin {
  ...
  final controller = Get.find<BalanceControllerV2>();

  MyBalanceV2Page({super.key, this.onBack});
...
class TarjetaYaPasoV2 extends StatelessWidget with ResponsiveMixin {
  final BalanceControllerV2? controller;
          ...
          if (index == controller.transactions.length) {
            ...
            if (controller.nextCursor != null &&
              ...
              return Padding(
                ...
                child: Center(
                  child: TextButton(
                    onPressed: controller.getMoreTransactions,
