  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: NotificationListener<UserScrollNotification>(
        ...
        child: GetBuilder<ProfileControllerV2>(
          id: 'profile_info',
          builder: (_) {
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "${controller.userSession.name} ${controller.userSession.lastName}",
                              ...
                              _buildCard(
                                children: [
                                  _buildRowItem("Número De Legajo",
                                      "${controller.userSession.fileNum}",
                                      isBoldValue: true),
                                  _buildDivider(),
                                  _buildRowItem("Edad",
                                  ...
                                  _buildDivider(),
                                  _buildRowItem("Turno",
                                      "${controller.userSession.turn ?? 'Sin Seleccionar'}",
                                      isBoldValue: true),
                                  _buildDivider(),
                                  _buildRowItem("Año",
                                  ...
                                  _buildRowItem("División",
                                      "${controller.userSession.curse_division ?? '-'}",
                                      isBoldValue: true),
                                ],
                              ),
                              SizedBox(height: setHeight(35)),
