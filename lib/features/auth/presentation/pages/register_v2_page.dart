              ...
              children: [
                ...
                Expanded(
                  child: PageView(
                    ...
                    children: [
                      SingleChildScrollView(child: Step1NameV2()),
                      Step2AgeV2(),
                      SingleChildScrollView(child: Step4LocationV2()),
                      SingleChildScrollView(child: Step5CredentialsV2()),
                    ],
                  ),
                ),
                SafeArea(
                  top: false,
                  child: Obx(
                    () => RegisterNavigationV2(
                      onBack: controller.previousStep,
                      onNext: controller.nextStep,
                      nextLabel: controller.currentStep.value == 3
                          ? 'Finalizar'
                          : 'Continuar',
                    ),
                  ),
...
class Step5CredentialsV2 extends GetView<AuthRegisterControllerV2>
    with ResponsiveMixin {
  const Step5CredentialsV2({super.key});
    ...
    return Padding(
      ...
      child: Column(
        children: [
          Text(
            'Último Paso',
            style: TextStyle(fontSize: setSp(24), fontWeight: FontWeight.bold),
          ),
          Text(
                ...
                ? Padding(
                    ...
                    child: Align(
                      ...
                      child: Text(
                        ...
                        style:
                            TextStyle(color: Colors.red, fontSize: setSp(12)),
                      ),
                    ),
                  )
...
class RegisterNavigationV2 extends StatelessWidget with ResponsiveMixin {
...
class CustomDropdownV2 extends StatelessWidget with ResponsiveMixin {
  final String label;
  final String value;
